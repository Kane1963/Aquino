...
client.on("connect",()=>{console.log("MQTT connesso"); client.subscribe(MQTT_TOPIC_CMD);});
...
app.post("/schedule",(req,res)=>{
  openTime=req.body.open; closeTime=req.body.close; lastAction="automatica";
  res.sendStatus(200);
});

app.post("/mode",(req,res)=>{
  mode=req.body.set; lastAction="automatica";
  res.sendStatus(200);
});
